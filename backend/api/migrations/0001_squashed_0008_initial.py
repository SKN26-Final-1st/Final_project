...
class Migration(migrations.Migration):
    replaces = [
        ...
        ("api", "0008_account_hash_authkey_fields"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "account_hash",
                    models.CharField(
                        default=api.models.generate_account_hash,
                        max_length=16,
                        unique=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("team_composition", models.JSONField(blank=True, default=list)),
                ("company_description", models.TextField(blank=True, default="")),
                ("employ_style", models.JSONField(blank=True, default=list)),
                (
                    "account",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("preferred_skill", models.JSONField(blank=True, null=True)),
                ("main_task", models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("self_intoduction", models.JSONField(blank=True, null=True)),
                ...
                ("other_activity", models.JSONField(blank=True, null=True)),
                (
                    "status",
                    models.CharField(
                        choices=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("concern", models.JSONField(blank=True, null=True)),
                ("check_point", models.JSONField(blank=True, null=True)),
